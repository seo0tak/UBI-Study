					...
					<div class="item">
						...
						<p class="message">
							<a href="#" class="name"> <small
								class="text-muted pull-right"><i class="fa fa-clock-o"></i>
									5:15</small> 관리자
							</a> 알아들을 수 있게 한글로 써라 양키 자식아. 나는 자랑스러운 대한민국의 국민이다.
						</p>
					</div>
					<!-- /.item -->
					<!-- chat item -->
				...
				<div class="box-footer no-border">
					<div class="row">
						<div class="col-xs-4 text-center"
							...
							<div class="knob-label">이메일 주문</div>
						</div>
						<!-- ./col -->
						<div class="col-xs-4 text-center"
							style="border-right: 1px solid #f4f4f4">
							<input type="text" class="knob" data-readonly="true" value="70"
								data-width="60" data-height="60" data-fgColor="#39CCCC">

							<div class="knob-label">온라인주문</div>
						</div>
						<!-- ./col -->
						<div class="col-xs-4 text-center">
							...
							<div class="knob-label">매장 내 주문</div>
						</div>
						<!-- ./col -->
					</div>
					<!-- /.row -->
