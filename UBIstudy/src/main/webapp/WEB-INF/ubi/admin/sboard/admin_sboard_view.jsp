...
<script type="text/javascript">
	...
	{
		location.href = "admin_sboard_update.ubi?num=" + num;
	}
...
<!-- Main content -->
    <section class="content">
              ...
              <table id="example2" class="table table-bordered table-hover">
                <tr>
                 ...
                 <tr>
                  ...
                  <td align="center" width="25%"><font color=gray>${bean.nick }</font></td>
                  <th align="center" width="25%">작성일</th>
                  <td align="center" width="25%"><font color=gray>${bean.day }</font></td>
                 </tr>
                 <tr>
                 <th align="center" width="25%">기간</th>
                  <td align="center" colspan=3><font color=gray>${bean.start_day } ~ ${bean.end_day }</font></td>
                 </tr>
                 <tr>
                  <th>제목</th>
                  <td colspan=3  align="center"><font color=gray>[${bean.lang}] ${bean.title }</font></td>
                </tr>
                <tr>
                	<th>내용</th>
                	<td colspan=3 align="center" height="300px"><font color=gray>${bean.memo }</font></td>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
      ...
      <tr>
      <td>
      <button type="button" class="btn btn-block btn-default" onClick="location.href='admin_sboard_list.ubi?pageNumber=${pageNumber}'">목록으로</button>
		</td>
		<td>
