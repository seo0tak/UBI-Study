...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">관리자 전용 글쓰기!
                ...
                <form:form commandName="fboard" method="post" action="admin_vboard_insert.ubi">
                <input type="text" name=title placeholder="제목 입력" required="required" size="70">
                <input type="text" name=price placeholder="가격 입력" required="required" size="30">
                <br>
                <input type="text" name=url placeholder="영상 URL을 입력하세요" size="110" required="required"><br>
